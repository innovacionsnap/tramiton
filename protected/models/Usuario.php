 ...
 * @property InstitucionUsuario $insu
...
class Usuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('usu_cedula, usu_nombre, usu_apellido, usu_direccion, usu_mail, usu_celular, usu_convencional, usu_nombreusuario, usu_contrasenia, usu_fechanacimiento, usu_estado', 'required'),
			array('insu_id, rol_id, par_id, usu_estado', 'numerical', 'integerOnly'=>true),
			array('usu_cedula, usu_celular, usu_convencional, usu_nombreusuario', 'length', 'max'=>20),
			array('usu_nombre, usu_apellido, usu_direccion, usu_mail, usu_contrasenia', 'length', 'max'=>50),
			array('usu_fecha_registro', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('usu_id, insu_id, rol_id, par_id, usu_cedula, usu_nombre, usu_apellido, usu_direccion, usu_mail, usu_celular, usu_convencional, usu_nombreusuario, usu_contrasenia, usu_fechanacimiento, usu_estado, usu_fecha_registro', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'insu' => array(self::BELONGS_TO, 'InstitucionUsuario', 'insu_id'),
	...
	public function search()
	{
		...
		$criteria->compare('insu_id',$this->insu_id);
