...
class Usuario extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            ...
            'solucions' => array(self::HAS_MANY, 'Solucion', 'usu_id'),
            'comentarios' => array(self::HAS_MANY, 'Comentario', 'usu_id'),
            'megustas' => array(self::HAS_MANY, 'Megusta', 'usu_id'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'usu_mail' => 'E-mail',
            'usu_celular' => 'Celular',
            'usu_convencional' => 'Convencional',
            'usu_nombreusuario' => 'Username',
            'usu_contrasenia' => 'Usu Contrasenia',
            'usu_fechanacimiento' => 'Fecha Nac.',
