<!-- begin #header -->
<div id="header" class="navbar navbar-default navbar-fixed-top header" style="border-bottom: 4px solid #325972; " > <!-- header-->
    
    <div class="container-fluid">

        <div class="navbar-header">
            <a class="" href="#"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo_tramiton1.png" alt="" /></a>
