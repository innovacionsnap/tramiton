...
<!-- begin scroll to top btn -->
	...
	<!-- ================== BEGIN PAGE LEVEL JS ================== -->
    <script src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/plugins/morris/raphael.min.js"></script>
    ...
    <script src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/plugins/jquery-jvectormap/jquery-jvectormap-world-merc-en.js"></script>
    <script src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/plugins/bootstrap-calendar/js/bootstrap_calendar.min.js"></script>
	<script src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/plugins/gritter/js/jquery.gritter.js"></script>
	<script src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/js/dashboard-v2.js"></script>
