...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Dashboard <small>una pequeña frase...</small></h1>
    <!-- end page-header -->
        ...
        <div class="col-md-3 col-sm-6">
            <div class="widget widget-stats bg-green">
                ...
                <div class="stats-link">
                    <a href="javascript:index.html;">Ver detalles<i class="fa fa-arrow-circle-o-right"></i></a>
                </div>
            </div>
        </div>
        <!-- end col-3 -->
        ...
        <div class="col-md-8">
            <div class="panel panel-inverse" data-sortable-id="index-1">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Analisis tramites 7 dias</h4>
                </div>
                        ...
                        <ul class="media-list media-list-with-divider">
                            <li class="media media-lg">
                                <a href="javascript:;" class="pull-left">
                                    <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/gallery/gallery-1.jpg" alt="" />
                                </a>
                            ...
                            <li class="media media-lg">
                                <a href="javascript:;" class="pull-left">
                                    <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/gallery/gallery-10.jpg" alt="" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-lg">
                                <a href="javascript:;" class="pull-left">
                                    <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/gallery/gallery-7.jpg" alt="" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-lg">
                                <a href="javascript:;" class="pull-left">
                                    <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/gallery/gallery-8.jpg" alt="" />
                                </a>
                                <div class="media-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="hidden-sm">
                                        <a href="javascript:;">
                                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/product/product-1.png" alt=""  />
                                        </a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-sm">
                                        <a href="javascript:;">
                                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/product/product-2.png" alt="" />
                                        </a>
                                    </td>
                                    <td>
                                        <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-sm">
                                        <a href="javascript:;">
                                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/product/product-3.png" alt="" />
                                        </a>
                                    </td>
                                    <td>
                                        <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-sm">
                                        <a href="javascript:;">
                                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/product/product-4.png" alt="" />
                                        </a>
                                    </td>
                                    <td>
                                        <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-tablet hidden-phone">
                                        <a href="javascript:;">
                                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/product/product-5.png" alt="" />
                                        </a>
                                    </td>
                                    <td>
                                        <h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
                    ...
                    <div class="height-sm" data-scrollbar="true">
                        <ul class="media-list media-list-with-divider">
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/user-1.jpg" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/user-2.jpg" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/user-3.jpg" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/user-4.jpg" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                ...
                <div class="panel-body">
                    <div class="height-sm" data-scrollbar="true">
                        <ul class="media-list media-list-with-divider media-messaging">
                            ...
                            <li class="media media-sm">
                                <a href="javascript:;" class="pull-left">
                                    <img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/user-7.jpg" alt="" class="media-object rounded-corner" />
                                </a>
                                <div class="media-body">
                                    <h5 class="media-heading">John Doe</h5>
        ...
        <div class="col-md-4">
            <div class="panel panel-inverse" data-sortable-id="index-6">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Detalles Análisis</h4>
                </div>
                <div class="panel-body p-t-0">
                    <table class="table table-valign-middle m-b-0">
                        ...
                        <tbody>
                            <tr>
                                <td><label class="label label-danger">Total visitantes</label></td>
                                <td>10,203 <span class="text-success"><i class="fa fa-arrow-up"></i></span></td>
                                <td><div id="sparkline-unique-visitor"></div></td>
                            </tr>
                            <tr>
                                <td><label class="label label-warning">Total de trámites</label></td>
                                <td>28.2%</td>
                                <td><div id="sparkline-bounce-rate"></div></td>
                            </tr>
                            <tr>
                                <td><label class="label label-success">Tratamientos seguiendo</label></td>
                                <td>1,230,030</td>
                                <td><div id="sparkline-total-page-views"></div></td>
                            </tr>
                            <tr>
                                <td><label class="label label-primary">Trámites pendientes</label></td>
                                <td>00:03:45</td>
