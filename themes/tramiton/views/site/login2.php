...
<head>
	...
	<link href="<?php echo Yii::app()->theme->baseUrl; ?>/assets/css/theme/default.css" rel="stylesheet" id="theme" /><!-- aqui va el default -->
	<!-- ================== END BASE CSS STYLE ================== -->
...
<body class="pace-top">
	...
	<div class="login-cover">
	    <div class="login-cover-image"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/login-bg/bg-1.jpg" data-id="login-cover-image" alt="" /></div>
	...
	<div id="page-container" class="fade">
        ...
        <ul class="login-bg-list">
            <li class="active"><a href="#" data-click="change-bg"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets/img/login-bg/bg-1.jpg" alt="" /></a></li>
