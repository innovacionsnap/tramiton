...
<head>
	...
	<link href="<?php echo Yii::app()->getBaseUrl(true); ?>/themes/tramiton/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
	...
	<link href="/tramiton2/themes/tramiton/assets/css/theme/red.css" id="theme" rel="stylesheet" />-->
        
        <!-- ================== Custom CSS ================== -->
	<link href="<?php echo Yii::app()->getBaseUrl(true); ?>/themes/tramiton/assets/css/style.css" rel="stylesheet" />
	<!--<link href="/tramiton2/themes/tramiton/assets/css/style-responsive.min.css" rel="stylesheet" />-->
	<link href="<?php echo Yii::app()->getBaseUrl(true); ?>/themes/tramiton/assets/css/main.css" rel="stylesheet" />
	<!-- ================== END Custom CSS=============== -->
                        ...
                        <td>
                                ...
                                <tr>
                                    ...
                                    <td class="wrapper">
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="last">
                                                    <h4>¡Bienvenido(a) <?php echo $model->nombre_usuario; ?> a Tramiton.to!</h4>
                                                    <p class="m-b-5">Ahora que te has registrado y creado tu cuenta, sólo tienes que activarla para poder empezar a registrar los trámites mas absurdos del sector público, da click en el siguiente botón.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="panel">
                                                    ...
                                                    <a href="<?php echo $url; ?>" target="_blank"><button class="btn btn-success btn-lg">ACTIVAR CUENTA</button></a>
                                                    <!--<a href="http://localhost/tramiton2/site/activarCuenta?email=<?php //echo $model->email; ?>&codigoVerificacion=<?php //echo $modelInsertUser->codigoVerificacion; ?>" target="_blank"><button class="btn btn-success btn-lg">ACTIVAR CUENTA</button></a>-->
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <p class="m-t-15 last">Si no te has registrado para crear una cuenta en Tramiton.to, puedes ignorar este mensaje. Alguien puede haber incluido tu dirección de correo electrónico por accidente.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table class="row">
                                <tr>
                                    ...
                                    <td class="wrapper">
                                        <p>
                                            <i>Este mensaje ha sido generado automáticamente, por favor no responda.</i>
                                        </p>
                                    </td>
                                    <!-- end wrapper -->
                                </tr>
                                ...
                                <table class="container">
                                    <tr>
                                        <td class="wrapper"><table class="six columns">
                                          <tr>
                                            <td><table class="six columns">
                                              <tr>
                                                  <td>&copy;  <a href="http://tramiton.to" target="_blank"> Tramiton.to</a> 2015. </td>
