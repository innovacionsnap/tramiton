...
?>
	...
	<link href="<?php echo Yii::app()->theme->baseUrl;?>/assets/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" />
	<link href="<?php echo Yii::app()->theme->baseUrl;?>/assets/plugins/bootstrap-datepicker/css/datepicker.css" rel="stylesheet" />
	<link href="<?php echo Yii::app()->theme->baseUrl;?>/assets/plugins/bootstrap-datepicker/css/datepicker3.css" rel="stylesheet" />
    <link href="<?php echo Yii::app()->theme->baseUrl;?>/assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" />
...
<body>
	...
	<script src="<?php echo Yii::app()->theme->baseUrl;?>/assets/js/dashboard.min.js"></script>
