                            ...
                            <div class="wizard-step-2">
                         		 ...
                         		 <fieldset>
                                    ...
                                    <div class="row">
					                    ...
					                    <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Describa la expereciencia</label>
                                                <div class="controls">
                                                    <textarea class="form-control" id="message" name="experiencia" rows="4" data-parsley-range="[20,200]" placeholder="Rango 20 - 200"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end row 6-->
