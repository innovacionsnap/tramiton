...
if ($_GET['buscar_institucion']=="institucion")
{
	...
	if ($var_institucion==''){
		...
		$consulta_tramite = "select trai.trai_id,ins.ins_id,ins.ins_nombre,tra.tra_nombre from tramite tra, tramite_institucion trai, institucion ins where tra.tra_id = trai.tra_id and trai.ins_id = ins.ins_id and ins.ins_id='".$var_institucion."' and trai.trai_estado=1 order by trai.tra_id,tra.tra_nombre";
