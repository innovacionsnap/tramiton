        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Ranking Trámites</h4>
                </div>
                            ...
                            <tbody>
                                ...
                                foreach ($rankings as $ranking):
                                    ...
                                    <tr class="odd gradeA">
                                        ...
                                        <td class="sorting_1"><?php echo $ranking['ins_nombre'] ?></td>
                                        <td class="sorting_1"><?php echo $ranking['soluciones'] ?></td>
                                    </tr>
