            ...
            <div class="panel-body p-t-0" style="margin-top:5px; border-radius: 8px">
                ...
                <div id="comentario-interno" data-scrollbar="true" style="max-height: 300px; padding-left: 20px; padding-right: 20px; background-color: #fff; border-radius:8px;overflow: auto">
                    ...
                    foreach ($comentario as $dato):
                        ...
                        ?>
                        <div class="row" style="border-bottom: 1px solid #f1f1f1; text-align: left; padding-top: 10px;"><p><font style="color:#348fe2;"><?php echo $usuario_comentario; ?></font style="word-wrap: break-word;"><font class="word-w"><?php echo " " . $dato['com_descripcion']; ?><br><?php echo $dato['com_fecha'] ?></font></p></div>
                    <?php endforeach; ?>
                </div>
