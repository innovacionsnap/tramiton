                                ...
                                <?php $tramiton="Tramitón Ciudadano";$cont=1;foreach ($datosTramitones as $datos) : ?>
                                    <tr class="odd gradeX">
                                        ...
                                        $tram = Yii::app()->encriptaParam->codificaParamGet($datos['datt_productivo']); 
                                            echo CHtml::link('<button type="button" class="btn btn-inverse active btn-xs m-r-5"><i class="fa fa-eye"></i> Mostrar</button>', array("reporte/viewprovincias", 'tram' => $tram), array('title' => 'Mostrar'));
                                            ?>
                                        </td>
                                    </tr>
                                <?php 
